...
all_indices = torch.LongTensor(all_indices)  # 形状：[样本数，seq_len]
...
all_labels = torch.LongTensor(all_labels)  # 形状：[样本数]
...
hidden_dim = 256
num_layers = 2
model = RNNClassifier(vocab_size, embedding_dim, hidden_dim=hidden_dim, output_dim=output_size, num_layers=num_layers)
