...
model = RNNClassifier(input_size=vocab_size, hidden_size=hidden_dim, output_size=output_dim)
#model = GRUClassifier(input_size=vocab_size, hidden_size=hidden_dim, output_size=output_dim) # loss 0.1463
#model = LSTMClassifier2(input_size=vocab_size,hidden_size=hidden_dim,output_size=output_dim) #Loss: 0.3951
