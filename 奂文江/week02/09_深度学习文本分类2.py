...
#层数为2 节点数为128 : Epoch [10/10], Loss: 0.5872
#层数为4 节点数为60 : Epoch [10/10], Loss: 1.3304
#层数为4 节点数为128 : Epoch [10/10], Loss: 1.3240
#层数为4 节点数为1024 : Epoch [10/10], Loss: 1.1460
#层数为4 节点数为2048 : Epoch [10/10], Loss: 0.9590
