...
model = LSTMClassifier(vocab_size, embedding_dim, hidden_dim, output_dim) #自由切换RNN、LTSM、GRU模型。
#LSTMClassifier(vocab_size, embedding_dim, hidden_dim, output_dim)
#GRUClassifier(vocab_size, embedding_dim, hidden_dim, output_dim)
#RNNClassifier(vocab_size, embedding_dim, hidden_dim, output_dim)
